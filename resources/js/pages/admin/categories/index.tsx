...
export default function AdminCategoriesIndex({
    ...
    function destroy(category: AdminCategory) {
        if (
            confirm(
                `¿Eliminar la categoría "${category.name}" de ${category.user.name}?`,
            )
        ) {
    ...
    return (
        <>
            <Head title="Categorías - Panel admin" />
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            {categories.total} categorías de todos los
                            usuarios.
                        </p>
                    </div>
                ...
                >
                    <DialogContent className="rounded-2xl sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Actualiza los datos de la categoría de{' '}
                                {editing?.user.name}.
                            </DialogDescription>
                        </DialogHeader>
