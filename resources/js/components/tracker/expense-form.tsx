...
export function ExpenseForm({
            ...
            return {
                ...
                items: [
                    ...values.items,
                    {
                        ...
                        rate_provider: currency === 'ves' ? choice : '',
                    },
                ],
            };
        });
    ...
    function handleItemCurrencyChange(
        ...
        if (currency === 'ves') {
            const choice = resolveChoice(data.rate_provider);
            const rateValue =
                choice === 'bcv'
                    ? String(rates.bcv)
                    : choice === 'paralelo'
                                ...
                                <div className="mt-2 flex items-end gap-2">
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            className="h-10 w-full bg-transparent font-display text-xl font-bold text-foreground tabular-nums focus:outline-none"
                                        />
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="rounded-lg bg-destructive/15 px-2.5 py-2 text-xs font-semibold text-destructive transition-colors hover:bg-destructive/25"
                                    >
                                        {t('expenses.form_mixed_remove')}
                                    </button>
                                </div>
                            </div>
                        ))}
