                ...
                <DialogTrigger asChild>
                    ...
                    >
                        ...
                        <span className="sr-only">
                            {t('settings.passkey_remove_aria')}
                        </span>
                    </Button>
                </DialogTrigger>
                <DialogContent>
                    <DialogTitle>
                        {t('settings.passkey_remove_title')}
                    </DialogTitle>
                    <DialogDescription>
                        {t('settings.passkey_remove_description', {
                            name: passkey.name,
                        })}
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        >
                            {isDeleting
                                ? t('settings.passkey_removing')
                                : t('settings.passkey_remove_button')}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
