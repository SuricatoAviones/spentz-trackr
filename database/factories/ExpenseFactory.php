...
class ExpenseFactory extends Factory
{
    ...
    /**
     * Set the expense currency to bolívares with a given exchange rate.
     */
    ...
    /**
     * Set the expense currency to USDT (1:1 with USD).
     */
    ...
    /**
     * Set the expense date to a specific day.
     */
    public function on(string $date): static
    {
        return $this->state(fn (): array => ['spent_at' => $date]);
    }
}
