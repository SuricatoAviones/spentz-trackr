...
return [
    ...
    'info' => [
        ...
        'description' => <<<'MD'
            ...
            Respuestas: `{ "success": bool, "data": mixed, "message": string }`. Errores de
            validación devuelven `422` con `message` + `errors` (formato estándar Laravel). Los
            usuarios suspendidos reciben `403`.
            MD,
    ],

    'ui' => [
        'title' => 'Spentz Trackr API',
    ],
